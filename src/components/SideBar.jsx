      ...
      <>
        <div className='fixed top-0 left-0 flex flex-col w-16 h-screen m-0 text-white shadow-lg bg-secondary-dark-bg '>
          <a id='home-button' ms-hide-element='true' href='home'>
            <SideBarIcon icon={<BsFillGridFill size='28' />} text='Home' />
          </a>
          <Divider />
          <a id='dashboard-button' ms-hide-element='true' href='dashboard'>
            <SideBarIcon
          ...
          <a id='profile-button' ms-hide-element='true' href='profile'>
            <SideBarIcon
              icon={
                <Image
          ...
          <a id='comps-button' ms-hide-element='true' href='admin'>
            <SideBarIcon icon={<BsWrench size='28' />} text='Admin' />
          </a>
